...
export default class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'yaus_link_generation/0.1 (api/5.0.0-beta.1)');
  }
...
export interface PostApiRegisterBodyParam {
  customHashId?: string;
  project?: string;
  user?: string;
  url?: string;
...
export type PostApiRegisterMetadataParam = {
  'Access-Control-Allow-Origin'?: string;
  [k: string]: unknown;
};
export type PostApiRegister_Response_201 = string;
